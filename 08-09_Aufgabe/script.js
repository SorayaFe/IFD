...
const info1 = document.getElementById("info12");
const info2 = document.getElementById("info22");
const info3 = document.getElementById("info32");
setListeners();
...
function drawCharts() {
  const data = google.visualization.arrayToDataTable([
    ["Land", "Anzahl"],
    [{ v: "Germany", f: "Deutschland" }, 55],
    [{ v: "Mexico", f: "Mexiko" }, 665],
    ["Japan", 300],
    [{ v: "United States", f: "USA" }, 475],
    ["San Marino", 0],
    [{ v: "Brazil", f: "Brasilien" }, 413],
    [{ v: "Canada", f: "Kanada" }, 93],
    [{ v: "Spain", f: "Spanien" }, 145],
    [{ v: "Russia", f: "Russland" }, 139],
    [{ v: "Australia", f: "Australien" }, 362],
    [{ v: "Nigeria", f: "Nigerien" }, 150],
    ["Kenya", 171],
    ["Thailand", 271],
    [{ v: "South Africa", f: "Südafrika" }, 241],
    [{ v: "India", f: "Indien" }, 340],
    [{ v: "Egypt", f: "Ägypten" }, 5],
  ]);
...
function drawPie() {
  ...
  const options = {
    title: "Bedrohte Arten (Gesamt in DE: 55 Stück)",
...
function drawBars() {
  ...
  const options = {
    title: "Anzahl bedrohter Tiere der Länder im Vergleich",
    bar: { groupWidth: "95%" },
...
function drawArea() {
  ...
  const options = {
    title: "Anzahl bedrohter Tiere in DE über die Jahre",
    hAxis: {
      title: "Jahr",
